import unittest
from case.fresh_purchase.apis_test.app_api.get_data import get_expect
from common.logger import Log
from case.fresh_purchase.apis_test.app_api.req_api import purchaseOrder
...
class testPurchase(unittest.TestCase):
    ...
    def test_purchase(self, expect):
        ...
        self.log.info('请求参数:{}'.format(self.res.request.body.decode('utf8')))
        self.log.info('=================================================')
